...
## Screenshot Workflow
- Puppeteer is installed at `C:/Users/diego/AppData/Local/Temp/puppeteer-test/`. Chrome cache is at `C:/Users/diego/.cache/puppeteer/`.
- Node.js is at `C:/Program Files/nodejs/node.exe`. Since `node` is not in the bash shell PATH, always invoke it as `"/c/Program Files/nodejs/node.exe"` in bash commands.
